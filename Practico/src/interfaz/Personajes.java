...
public class Personajes {
	...
	/* Los botones est�n solamente presentados.
	 * Hay que agrupar los textbox del formulario. 
	 * Ver como manejar en el c�digo cuando un personaje es nuevo y cuando se edit� uno existente.
	...
	private void guardar(){
		if (!validarDatos()){ //El mismo m�todo informa el error
			return; 
		}		
	...
	private Boolean validarDatos(){
		//Valido que los textboxs contengan solamente n�meros!
